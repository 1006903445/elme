                ...
                <div class="food-content">
                    ...
                    <div class="content">
                        ...
                        <transition name="fade">
                            <div class="buy" @click="_addFirst" v-show="!food.count || food.count == 0">加入购物车</div>
                        </transition>
                    </div>
                    ...
                    <div class="rating">
                        ...
                        <div class="rating-wrapper">
                            <ul v-if="food.ratings && showRatings.length">
                                <li v-for="rating in showRatings" class="rating-item border-1px">
                                    <div class="user">
